...
public class MealTestData {
    ...
    public static final Meal meal1 = new Meal(
            MEAL_ID1, LocalDateTime.of(2021, Month.FEBRUARY, 27, 12, 34), "Завтрак", 500);
    public static final Meal meal2 = new Meal(
            MEAL_ID2, LocalDateTime.of(2021, Month.FEBRUARY, 27, 15, 34), "Обед", 1000);
    public static final Meal meal3 = new Meal(
            MEAL_ID3, LocalDateTime.of(2021, Month.FEBRUARY, 27, 21, 34), "Ужин", 500);
    public static final Meal meal4 = new Meal(
            MEAL_ID4, LocalDateTime.of(2021, Month.FEBRUARY, 27, 12, 34), "Завтрак", 1000);
    public static final Meal meal5 = new Meal(
            MEAL_ID5, LocalDateTime.of(2021, Month.FEBRUARY, 27, 15, 34), "Обед", 1000);
    public static final Meal meal6 = new Meal(
            MEAL_ID6, LocalDateTime.of(2021, Month.FEBRUARY, 27, 22, 34), "Ужин", 500);
